  ...
  return (
    <header className="sticky top-0 z-10 border-b border-slate-200 bg-slate-50/90 backdrop-blur dark:border-[#303030] dark:bg-[#111111]/90">
      <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <button type="button" onClick={onThemeToggle} className="grid h-9 w-9 place-items-center rounded-lg border border-slate-200 bg-white text-slate-600 hover:bg-slate-100 dark:border-[#3a3a3a] dark:bg-[#171717] dark:text-slate-300 dark:hover:bg-[#242424]" aria-label={`Switch to ${isDark ? 'light' : 'dark'} mode`}>
