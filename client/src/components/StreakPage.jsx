...
function StreakPage() {
  ...
  return <>
    <div className="mb-8"><p className="mb-2 text-sm font-medium text-violet-600 dark:text-violet-400">Streaks</p><h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">Build your daily solving habit</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500 dark:text-slate-400">Solve at least one problem in a day to make that day active and keep your streak alive.</p></div>
