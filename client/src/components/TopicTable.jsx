    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-[#303030] dark:bg-[#171717]">
      <div className="overflow-x-auto">
        <table className="w-full min-w-[680px] text-left text-sm">
          <thead className="border-b border-slate-200 bg-slate-50 text-xs uppercase tracking-wide text-slate-500 dark:border-[#303030] dark:bg-[#111111] dark:text-slate-400">
            <tr>
              ...
              return (
                <tr key={topic.id} className="group hover:bg-slate-50 dark:hover:bg-[#242424]/50">
                  ...
                  <td className="px-5 py-4 text-right">
                    <button type="button" onClick={() => onSelectTopic(topic)} className="cursor-pointer rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-semibold text-violet-600 hover:border-violet-200 hover:bg-violet-50 dark:border-[#3a3a3a] dark:text-violet-300 dark:hover:border-violet-800 dark:hover:bg-violet-950/30">
                      View problems
                    </button>
                  </td>
                </tr>
